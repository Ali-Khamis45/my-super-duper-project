...
- **All 5 real cup parts migrated** (`ProceduralCup`/`Sleeve`/`Lid`/`Coffee`/`Foam`): every case routes through `getOrCreateMaterial`, `materialOverrides` included. **Updated, Sprint 3.2**: `materialOverrides` got its first real caller (`features/customizer/`) this sprint, revealing that a `materialOverrides`-bearing instance being *created directly, never cached* (this sprint's original design) meant the customizer's every selection bypassed the cache entirely — never sharing already-compiled work even for a previously-seen combination. Fixed by routing overrides through the *same* cache with a richer key (`MaterialCacheKey.variant` now encodes the override signature via `features/hero-cup/lib/materialOverridesToVariant.ts`), so distinct combinations never collide and repeated ones are real cache hits. The Hero route's own default (no-override) key is provably unchanged by this fix — see [reviews/sprint-3.2-review.md](reviews/sprint-3.2-review.md).
...
[16_ENGINEERING_SPRINTS.md](16_ENGINEERING_SPRINTS.md) · [28_MILESTONE_3_SPRINTS.md](28_MILESTONE_3_SPRINTS.md) · [reviews/sprint-2.1-review.md](reviews/sprint-2.1-review.md) · [reviews/sprint-2.2-review.md](reviews/sprint-2.2-review.md) · [reviews/sprint-2.3-review.md](reviews/sprint-2.3-review.md) · [reviews/sprint-2.4-review.md](reviews/sprint-2.4-review.md) · [reviews/sprint-2.5-review.md](reviews/sprint-2.5-review.md) · [reviews/sprint-2.6-review.md](reviews/sprint-2.6-review.md) · [reviews/sprint-3.2-review.md](reviews/sprint-3.2-review.md) · [11_TESTING_QA.md](11_TESTING_QA.md) · [15_ARCHITECTURE_FREEZE.md](15_ARCHITECTURE_FREEZE.md) · [17_ZERO_REWRITE_POLICY.md](17_ZERO_REWRITE_POLICY.md) · [22_MANAGER_INTERFACES.md](22_MANAGER_INTERFACES.md) · [04_MOTION_ENGINE.md](04_MOTION_ENGINE.md) · [12_INTERACTION_SYSTEM.md](12_INTERACTION_SYSTEM.md) · [13_SHADER_ARCHITECTURE.md](13_SHADER_ARCHITECTURE.md) · [14_PERFORMANCE_STRATEGY.md](14_PERFORMANCE_STRATEGY.md) · [3d-asset-pipeline.md](3d-asset-pipeline.md) · [adr/0002](adr/0002-r3f-architecture.md) · [adr/0003](adr/0003-theme-system.md) · [adr/0006](adr/0006-scene-management-strategy.md)
